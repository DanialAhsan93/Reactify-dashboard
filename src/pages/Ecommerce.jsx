...
import { Stacked, Button, SparkLine } from '../component';
    ...
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        <div className={`bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full
         lg:w-60 p-8 pt-9 m-3 ${ currentMode === 'Dark' ? "bg-hero-pattern-sec" :"bg-hero-pattern"} bg-no-repeat bg-center bg-cover`}>
